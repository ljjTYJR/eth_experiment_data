...
set output "apartment-pose-ratio.tex"
set key left top
...
plot "posetranslation.bat" using 2:xtic(1) notitle w lp ls 1 pt 12 ps 2.5,\
"posetranslation.bat" using 3 notitle w lp ls 1 pt 21 ps 2.5,\
"posetranslation.bat" using 4 notitle w lp ls 1 pt 11 ps 2.5,\
"poserotation.bat" using 2:xtic(1) notitle w lp ls 2 pt 12 ps 2.5,\
"poserotation.bat" using 3 notitle w lp ls 2 pt 21 ps 2.5,\
"poserotation.bat" using 4 notitle w lp ls 2 pt 11 ps 2.5,\
NaN ls 1 title "Translation",\
NaN ls 2 title "Rotation",\
NaN with points pt 12 ps 2.0 lc rgb "black" title "Easy Pose",\
NaN with points pt 21 ps 2.0 lc rgb "black" title "Medium Pose",\
NaN with points pt 11 ps 2.0 lc rgb "black" title "Hard Pose"
