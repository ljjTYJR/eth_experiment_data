...
set output "apartment-overlap-ratio.tex"
set key left top
...
NaN with points pt 1 ps 2.0 lc rgb "black" title "High",\
NaN with points pt 9 ps 2.0 lc rgb "black" title "Medium",\
NaN with points pt 4 ps 2.0 lc rgb "black" title "Low"
